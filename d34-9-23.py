...
#print(np.unique(y)) # the three classes there are are 1 2 and 3, which need to be changed
y = y - 1 # changing the classes to 0 1 and 2
...
print("Actual:", np.bincount(y, minlength=3))

weights, biases = neural_network_multiple_hidden_layers([13,16,8,3], 5000, X_normalized, y, 0.2, 0.1, 0.1)
...
mult_layer_accuracy, mult_confusion = test_my_neural_network(weights, biases, testing_X_normalized, testing_y, 3)
