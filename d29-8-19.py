...
def neural_network_multiple_hidden_layers(layer_sizes, iterations, X, y, learning_rate, momentum, use_He=True):
    ...
    for i in range(iterations):
        ...
        for l in range(len(weights)):
            weight_velocities[l] = (
                momentum * weight_velocities[l]
                - learning_rate * weight_gradients[l]
            ...
            bias_velocities[l] = (
                momentum * bias_velocities[l]
                - learning_rate * bias_gradients[l]
            )

            biases[l] += bias_velocities[l]
...
# multiple layers
weights, biases, loss_lst = neural_network_multiple_hidden_layers([2,8,8,5], 2500, X_normalized, grade, 1, 0.1, use_He=True)
